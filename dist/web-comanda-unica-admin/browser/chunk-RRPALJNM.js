...
var ExtratoService = class _ExtratoService {
  ...
  exportCsvAsync(companyId, filtros = {}) {
    return this.http.post(`${this.baseUrl}/${companyId}/extrato/export/async`, null, { params: this.toHttpParams(filtros) });
  }
  // Polling do job criado por exportCsvAsync.
  getExportJob(companyId, jobId) {
    return this.http.get(`${this.baseUrl}/${companyId}/extrato/export/${jobId}`);
  }
...
var PlatformExtratoService = class _PlatformExtratoService {
  ...
  // tarefa.extrato.exportacao.csv.queue) — evita segurar a requisição HTTP durante a varredura
  // completa da Stripe. Acompanhar com getExportJob.
  exportCsvAsync(filtros = {}) {
    return this.http.post(`${this.baseUrl}/export/async`, null, { params: this.toHttpParams(filtros) });
  }
  // Polling do job criado por exportCsvAsync.
  getExportJob(jobId) {
    return this.http.get(`${this.baseUrl}/export/${jobId}`);
  }
  toHttpParams(filtros) {
    const params = {};
    if (filtros.startDate)
...
var _c0 = () => ["/painel/comandas"];
var _c1 = (a0) => ({ comanda: a0 });
...
function ExtratoFinanceiroComponent_Conditional_10_Conditional_36_Conditional_1_For_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275classProp("extrato-status--pending", ctx_r1.isPlatformStatusPending(transacao_r18));
    \u0275\u0275advance();
...
function ExtratoFinanceiroComponent_Conditional_11_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
...
function ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "dt");
    \u0275\u0275text(2, "Mesa");
    \u0275\u0275elementEnd();
...
function ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "dt");
    \u0275\u0275text(2, "Cliente");
    \u0275\u0275elementEnd();
...
function ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r25 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 54);
    \u0275\u0275listener("click", function ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Conditional_3_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " Abrir a comanda paga ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const transacao_r24 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(2, _c0))("queryParams", \u0275\u0275pureFunction1(3, _c1, transacao_r24.comandaUnica.comandaId));
  }
}
function ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "dl", 50);
    \u0275\u0275template(1, ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Conditional_1_Template, 5, 1, "div")(2, ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Conditional_2_Template, 5, 1, "div");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Conditional_3_Template, 4, 5, "a", 53);
  }
  if (rf & 2) {
    const transacao_r24 = \u0275\u0275nextContext();
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(transacao_r24.comandaUnica.mesa != null ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(transacao_r24.comandaUnica.cliente ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.podeAbrirComanda(transacao_r24) ? 3 : -1);
  }
}
function ExtratoFinanceiroComponent_Conditional_11_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 14);
    \u0275\u0275text(1, "Este lan\xE7amento n\xE3o est\xE1 vinculado a uma comanda.");
    \u0275\u0275elementEnd();
  }
}
function ExtratoFinanceiroComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "dl", 50)(9, "div", 51)(10, "dt");
    \u0275\u0275text(11, "Do que se trata");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(28);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(29, "dl", 50)(30, "div")(31, "dt");
    \u0275\u0275text(32, "Valor bruto");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "dd");
    \u0275\u0275text(34);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div")(36, "dt");
    \u0275\u0275text(37, "Taxa Stripe");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "dd");
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(40, ExtratoFinanceiroComponent_Conditional_11_Conditional_40_Template, 5, 1, "div");
    \u0275\u0275elementStart(41, "div")(42, "dt");
    \u0275\u0275text(43, "Valor l\xEDquido");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "dd");
    \u0275\u0275text(45);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(46, "h3", 52);
    \u0275\u0275text(47, "Stripe");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "dl", 50)(49, "div")(50, "dt");
    \u0275\u0275text(51, "PaymentIntent");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(58);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(59, "div")(60, "dt");
    \u0275\u0275text(61, "Balance Transaction");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "dd");
    \u0275\u0275text(63);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(64, "h3", 52);
    \u0275\u0275text(65, "Comanda \xDAnica");
    \u0275\u0275elementEnd();
    \u0275\u0275template(66, ExtratoFinanceiroComponent_Conditional_11_Conditional_66_Template, 4, 3)(67, ExtratoFinanceiroComponent_Conditional_11_Conditional_67_Template, 2, 0, "p", 14);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate(transacao_r24.descricao || ctx_r1.tipoLabel(transacao_r24.tipo));
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(transacao_r24.taxaComandaUnica != null ? 40 : -1);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(transacao_r24.comandaUnica.vinculado ? 66 : 67);
  }
}
function ExtratoFinanceiroComponent_Conditional_12_Conditional_65_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const transacao_r27 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(transacao_r27.relatedCompanyName);
  }
}
...
function ExtratoFinanceiroComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const transacao_r27 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate(ctx_r1.platformStatusLabel(transacao_r27));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.platformTipoLabel(transacao_r27.category));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(transacao_r27.stripeType);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(transacao_r27.direction === "CREDIT" ? "Entrada" : "Sa\xEDda");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatDateTime(transacao_r27.createdAt));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(transacao_r27.amount));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(transacao_r27.fee));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(transacao_r27.net));
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(transacao_r27.balanceTransactionId);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(transacao_r27.sourceId || "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(transacao_r27.relatedCompanyName ? 65 : 66);
  }
}
var PERIOD_PRESETS = [
  { id: "hoje", label: "Hoje" },
...
var ExtratoFinanceiroComponent = class _ExtratoFinanceiroComponent {
  ...
  statusLabel(transacao) {
    ...
    if (this.isLedgerOnlyType(transacao.tipo)) {
      return transacao.status === "AVAILABLE" ? "Conclu\xEDdo" : "Conclu\xEDdo (saldo pendente)";
    }
    return transacao.status === "AVAILABLE" ? "Dispon\xEDvel" : "Pendente";
  }
  isStatusPending(transacao) {
    return !transacao.pagamentoConfirmado && !transacao.estornoConfirmado && !this.isLedgerOnlyType(transacao.tipo) && transacao.status === "PENDING";
  }
  ...
  isPlatformStatusPending(transacao) {
  ...
  isLedgerOnlyType(tipo) {
    return tipo === "APPLICATION_FEE" || tipo === "APPLICATION_FEE_REFUND" || tipo === "STRIPE_FEE" || tipo === "PAYOUT" || tipo === "TRANSFER" || tipo === "DISPUTE" || tipo === "ADJUSTMENT";
  }
  ...
  static EXPORT_POLL_INTERVAL_MS = 2e3;
  static EXPORT_POLL_MAX_ATTEMPTS = 60;
  // ~2min
  exportCsv() {
    if (this.platformMode()) {
      this.isExporting.set(true);
      this.exportError.set(null);
      this.platformExtratoService.exportCsvAsync({
    ...
    this.isExporting.set(true);
    this.exportError.set(null);
    this.extratoService.exportCsvAsync(companyId, {
      startDate: this.startDate(),
      endDate: this.endDate(),
      type: this.typeFilter() || void 0,
  ...
  pollExportJob(fetchJob, jobId, attempt = 0) {
    if (attempt >= _ExtratoFinanceiroComponent.EXPORT_POLL_MAX_ATTEMPTS) {
      this.exportError.set("A exporta\xE7\xE3o est\xE1 demorando mais que o esperado. Tente novamente em instantes.");
    ...
    fetchJob(jobId).subscribe({
      next: (job) => {
        ...
        if (job.status === "FAILED") {
          this.exportError.set(job.error ?? "N\xE3o foi poss\xEDvel exportar o extrato.");
          this.isExporting.set(false);
          return;
        }
        setTimeout(() => this.pollExportJob(fetchJob, jobId, attempt + 1), _ExtratoFinanceiroComponent.EXPORT_POLL_INTERVAL_MS);
      },
      error: () => this.onExportError()
    });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExtratoFinanceiroComponent, selectors: [["app-extrato-financeiro"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 4, consts: [[1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "card", "extrato-company"], [1, "extrato-company__search"], [1, "extrato-company__label"], [1, "extrato-company__selected"], [1, "card"], [1, "modal-backdrop"], ["type", "button", "appRipple", "", 1, "extrato-company__platform-btn", 3, "click"], ["aria-hidden", "true", 1, "material-icons"], [1, "extrato-company__search-row"], ["type", "text", "placeholder", "Buscar estabelecimento por nome\u2026", 3, "input", "keyup.enter", "value"], ["type", "button", "appRipple", "", 1, "btn", "btn--ghost", 3, "click"], [1, "field__hint"], [1, "extrato-company__results"], ["type", "button", 3, "click"], [3, "change", "value"], [3, "value"], [1, "card", "extrato-summary"], [1, "card", "extrato-filters"], [1, "extrato-filters__row"], [1, "revenue-section__presets"], ["type", "button", 1, "revenue-section__preset", 3, "revenue-section__preset--active"], [1, "extrato-filters__dates"], [1, "revenue-section__date-field"], ["type", "date", 3, "change", "value", "max"], ["type", "date", 3, "change", "value", "min"], ["type", "text", "placeholder", "Buscar por PaymentIntent, Charge, Balance Transaction ou comanda\u2026", 1, "extrato-filters__search", 3, "input", "keyup.enter", "value"], ["type", "button", "appRipple", "", 1, "btn", "btn--ghost", 3, "click", "disabled"], ["role", "alert", 1, "form-alert", "form-alert--error"], [1, "card", "extrato-table-card"], [1, "stat-grid"], [1, "stat-card"], ["aria-hidden", "true", 1, "material-icons", "stat-card__icon"], [1, "stat-card__label"], [1, "stat-card__value"], ["type", "button", 1, "revenue-section__preset", 3, "click"], [1, "extrato-table-wrapper"], [1, "extrato-table"], [1, "extrato-table__number"], [1, "extrato-table__row"], [1, "extrato-load-more"], [1, "extrato-table__row", 3, "click"], [1, "extrato-status"], [1, "modal-backdrop", 3, "click"], [1, "modal-card", "card", 3, "click"], [1, "modal-card__header"], [1, "step-heading"], ["type", "button", "aria-label", "Fechar", 1, "icon-btn", 3, "click"], [1, "extrato-detail"], [1, "extrato-detail__wide"], [1, "extrato-detail__section-title"], [1, "btn", "btn--ghost", "btn--sm", 3, "routerLink", "queryParams"], [1, "btn", "btn--ghost", "btn--sm", 3, "click", "routerLink", "queryParams"]], template: function ExtratoFinanceiroComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(9, ExtratoFinanceiroComponent_Conditional_9_Template, 3, 0, "div", 7)(10, ExtratoFinanceiroComponent_Conditional_10_Template, 39, 14)(11, ExtratoFinanceiroComponent_Conditional_11_Template, 68, 12, "div", 8)(12, ExtratoFinanceiroComponent_Conditional_12_Template, 67, 11, "div", 8);
    }
    if (rf & 2) {
      let tmp_2_0;
      let tmp_3_0;
