...
function ReservasComponent_Conditional_18_Conditional_6_For_2_Conditional_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", reservation_r4.guestName || "Sem nome", "", reservation_r4.guestPhone ? " \xB7 " + reservation_r4.guestPhone : "", " ");
  }
}
...
function ReservasComponent_Conditional_18_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, ReservasComponent_Conditional_18_Conditional_6_For_2_Conditional_16_Template, 4, 2, "p", 22)(17, ReservasComponent_Conditional_18_Conditional_6_For_2_Conditional_17_Template, 4, 1, "p", 23);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(reservation_r4.guestName || reservation_r4.guestPhone ? 16 : -1);
    \u0275\u0275advance();
...
function ReservasComponent_Conditional_18_Conditional_12_Conditional_1_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", reservation_r5.guestName || "Sem nome", " \xB7 segurava at\xE9 ", ctx_r0.formatDateTime(reservation_r5.holdUntil), " ");
    \u0275\u0275advance(2);
...
function ReservasComponent_Conditional_18_Conditional_12_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ReservasComponent_Conditional_18_Conditional_12_Conditional_1_For_2_Template, 9, 5, "li", 29, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function ReservasComponent_Conditional_19_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "span", 5);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ReservasComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(38, "Observa\xE7\xE3o (opcional)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 41);
    \u0275\u0275element(40, "textarea", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(41, ReservasComponent_Conditional_19_Conditional_41_Template, 4, 1, "div", 7);
    \u0275\u0275elementStart(42, "div", 54)(43, "button", 55);
    \u0275\u0275text(44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "button", 56);
    \u0275\u0275listener("click", function ReservasComponent_Conditional_19_Template_button_click_45_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeCreateModal());
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(18);
    \u0275\u0275conditional(ctx_r0.createError() ? 41 : -1);
    \u0275\u0275advance(2);
...
var ReservasComponent = class _ReservasComponent {
  ...
  dateTimeFormatter = new Intl.DateTimeFormat("pt-BR", { day: "2-digit", month: "2-digit", hour: "2-digit", minute: "2-digit" });
  reservations = signal([]);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReservasComponent, selectors: [["app-admin-reservas"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 20, vars: 4, consts: [[1, "page-header", "page-header--row"], [1, "page-title"], [1, "page-subtitle"], [1, "page-header__actions"], ["type", "button", "appRipple", "", 1, "btn", "btn--ghost", 3, "click", "disabled"], ["aria-hidden", "true", 1, "material-icons"], ["type", "button", "appRipple", "", 1, "btn", "btn--primary", 3, "click"], ["role", "alert", 1, "form-alert", "form-alert--error"], [1, "field__hint"], [1, "modal-backdrop"], [1, "reservas-section"], [1, "reservas-section__title"], [1, "badge", "badge--muted"], [1, "reservas-grid"], ["type", "button", 1, "reservas-section__toggle", 3, "click"], [1, "reserva-card", "card", 3, "reserva-card--overdue"], [1, "reserva-card", "card"], [1, "reserva-card__header"], [1, "reserva-card__table"], [1, "badge"], [1, "reserva-card__hold"], [1, "reserva-card__countdown"], [1, "reserva-card__guest"], [1, "reserva-card__notes"], [1, "reserva-card__meta"], [1, "reserva-card__actions"], ["type", "button", "appRipple", "", 1, "btn", "btn--primary", "btn--sm", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn--ghost", "btn--sm", 3, "click", "disabled"], [1, "reservas-resolved"], [1, "reservas-resolved__item"], [1, "reservas-resolved__table"], [1, "reservas-resolved__info"], [1, "reservas-resolved__when"], [1, "modal-backdrop", 3, "click"], [1, "modal-card", "modal-card--sm", "card", 3, "click"], [1, "modal-card__header"], [1, "step-heading"], ["type", "button", "aria-label", "Fechar", 1, "icon-btn", 3, "click"], ["novalidate", "", 3, "submit", "formGroup"], [1, "field"], ["for", "reserva-table", 1, "field__label"], [1, "field__control"], ["id", "reserva-table", "formControlName", "tableId", 1, "field__input"], ["value", "", "disabled", ""], [3, "value"], [1, "field__error"], ["for", "reserva-hold", 1, "field__label"], ["id", "reserva-hold", "type", "datetime-local", "formControlName", "holdUntil", 1, "field__input"], ["for", "reserva-guest", 1, "field__label"], ["id", "reserva-guest", "type", "text", "formControlName", "guestName", "maxlength", "150", 1, "field__input"], ["for", "reserva-phone", 1, "field__label"], ["id", "reserva-phone", "type", "tel", "formControlName", "guestPhone", "maxlength", "30", 1, "field__input"], ["for", "reserva-notes", 1, "field__label"], ["id", "reserva-notes", "rows", "2", "formControlName", "notes", "maxlength", "1000", 1, "field__input"], [1, "step-actions"], ["type", "submit", "appRipple", "", 1, "btn", "btn--primary", 3, "disabled"], ["type", "button", 1, "btn", "btn--ghost", 3, "click"]], template: function ReservasComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(15, ReservasComponent_Conditional_15_Template, 4, 1, "div", 7)(16, ReservasComponent_Conditional_16_Template, 2, 0, "p", 8)(17, ReservasComponent_Conditional_17_Template, 4, 1, "div", 7)(18, ReservasComponent_Conditional_18_Template, 13, 4)(19, ReservasComponent_Conditional_19_Template, 47, 9, "div", 9);
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReservasComponent, { className: "ReservasComponent", filePath: "src\\app\\features\\admin\\pages\\reservas\\reservas.component.ts", lineNumber: 34 });
})();
export {
  ReservasComponent
};
//# sourceMappingURL=chunk-V4SKNG5E.js.map
