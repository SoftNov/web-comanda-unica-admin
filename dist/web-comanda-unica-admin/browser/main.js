...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-KT3NNPWH.js").then((m) => m.HomeComponent),
    title: "Comanda \xDAnica \u2014 Comanda digital sem mensalidade para bares e restaurantes"
  },
  {
    path: "entrar",
    loadComponent: () => import("./chunk-KVQ25Y3V.js").then((m) => m.LoginComponent),
    title: "Entrar \u2014 Comanda \xDAnica"
  },
  {
    path: "recuperar-senha",
    loadComponent: () => import("./chunk-3ZGRRBV5.js").then((m) => m.ForgotPasswordComponent),
    title: "Recuperar Senha \u2014 Comanda \xDAnica"
  },
  {
    path: "criar-conta",
    loadComponent: () => import("./chunk-EXWORJ2Y.js").then((m) => m.RegisterComponent),
    title: "Criar Conta \u2014 Comanda \xDAnica"
  },
  {
    path: "ativar-conta/:token",
    loadComponent: () => import("./chunk-GUI2KOO6.js").then((m) => m.ActivateAccountComponent),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-M2GAQSQ3.js").then((m) => m.ComandasComponent),
        title: "Comandas \u2014 Comanda \xDAnica"
      },
      {
        path: "mesas",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-6VNROCO7.js").then((m) => m.TablesComponent),
        title: "Mesas \u2014 Comanda \xDAnica"
      },
      {
        path: "cardapio",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-WCERA2BG.js").then((m) => m.MenuComponent),
        title: "Card\xE1pio \u2014 Comanda \xDAnica"
      },
      {
        path: "pedidos",
        loadComponent: () => import("./chunk-TKAWTLQ6.js").then((m) => m.PedidosComponent),
        title: "Pedidos \u2014 Comanda \xDAnica"
      },
      {
        path: "servicos",
        canActivate: [profileGuard(["OWNER", "ADMIN", "MANAGER", "CASHIER", "WAITER"])],
        loadComponent: () => import("./chunk-NAKBNMKN.js").then((m) => m.ServicosComponent),
      ...
      },
      {
        path: "funcionarios",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-EDDHWFW5.js").then((m) => m.EmployeesComponent),
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-OMTA3EXW.js").then((m) => m.ProfileComponent),
        title: "Meu Perfil \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/redefinir-senha",
        loadComponent: () => import("./chunk-HSPMX2QY.js").then((m) => m.SecurityComponent),
        title: "Redefinir Senha \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/pagamentos",
        canActivate: [profileGuard(["OWNER", "ADMIN"])],
        loadComponent: () => import("./chunk-MSGWJMKU.js").then((m) => m.OwnerStripePageComponent),
        title: "Pagamentos \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/stripe-plataforma",
        canActivate: [platformAdminGuard],
        loadComponent: () => import("./chunk-A53WKJS3.js").then((m) => m.AdminStripeConfigPageComponent),
        title: "Stripe da Plataforma \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/mapa-salao",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-5AC4LPE7.js").then((m) => m.FloorPlanListComponent),
        title: "Mapa do Sal\xE3o \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/mapa-salao/:id",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-7CMHCMAF.js").then((m) => m.FloorPlanEditorComponent),
        title: "Mapa do Sal\xE3o \u2014 Comanda \xDAnica"
      },
  ...
  {
    path: "termos-de-uso",
    loadComponent: () => import("./chunk-OUQIOD6H.js").then((m) => m.TermsComponent),
    title: "Termos de Uso \u2014 Comanda \xDAnica"
  },
  {
    path: "politica-de-privacidade",
    loadComponent: () => import("./chunk-BJ2MK4PS.js").then((m) => m.PrivacyComponent),
