...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-HVRIUJZA.js").then((m) => m.HomeComponent),
    title: "Comanda \xDAnica \u2014 Comanda digital sem mensalidade para bares e restaurantes"
  },
  {
    path: "entrar",
    loadComponent: () => import("./chunk-SMT7HRLF.js").then((m) => m.LoginComponent),
    title: "Entrar \u2014 Comanda \xDAnica"
  },
  {
    path: "criar-conta",
    loadComponent: () => import("./chunk-ZTUBFD3S.js").then((m) => m.RegisterComponent),
    title: "Criar Conta \u2014 Comanda \xDAnica"
  },
  {
    path: "ativar-conta/:token",
    loadComponent: () => import("./chunk-S7AYBHC2.js").then((m) => m.ActivateAccountComponent),
    title: "Ativar Conta \u2014 Comanda \xDAnica"
  },
  {
    path: "termos-de-uso",
    loadComponent: () => import("./chunk-JPL27YRF.js").then((m) => m.TermsComponent),
    title: "Termos de Uso \u2014 Comanda \xDAnica"
  },
  {
    path: "politica-de-privacidade",
    loadComponent: () => import("./chunk-DYFCNKL3.js").then((m) => m.PrivacyComponent),
