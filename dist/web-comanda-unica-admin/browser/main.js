...
function profileGuard(allowedProfileCodes) {
  return () => {
    const authService = inject(AuthService);
    const router = inject(Router);
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-SLGKNHQV.js").then((m) => m.HomeComponent),
    title: "Comanda \xDAnica \u2014 Comanda digital sem mensalidade para bares e restaurantes"
  },
  {
    path: "entrar",
    loadComponent: () => import("./chunk-MJRHEFQ4.js").then((m) => m.LoginComponent),
    title: "Entrar \u2014 Comanda \xDAnica"
  },
  {
    path: "recuperar-senha",
    loadComponent: () => import("./chunk-EEEDFY7G.js").then((m) => m.ForgotPasswordComponent),
    title: "Recuperar Senha \u2014 Comanda \xDAnica"
  },
  {
    path: "criar-conta",
    loadComponent: () => import("./chunk-ANT4HRTI.js").then((m) => m.RegisterComponent),
    title: "Criar Conta \u2014 Comanda \xDAnica"
  },
  {
    path: "ativar-conta/:token",
    loadComponent: () => import("./chunk-TWQAPBCU.js").then((m) => m.ActivateAccountComponent),
    title: "Ativar Conta \u2014 Comanda \xDAnica"
  },
  {
    path: "painel",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-7I66KXID.js").then((m) => m.AdminLayoutComponent),
    children: [
      { path: "", pathMatch: "full", canActivate: [homeGuard], children: [] },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-XBP23QP4.js").then((m) => m.DashboardComponent),
        title: "Dashboard \u2014 Comanda \xDAnica"
      },
      {
        path: "comandas",
        canActivate: [profileGuard(["OWNER", "ADMIN", "MANAGER", "CASHIER", "WAITER"])],
        loadComponent: () => import("./chunk-HYT2UVCO.js").then((m) => m.ComandasComponent),
        title: "Comandas \u2014 Comanda \xDAnica"
      },
      {
        path: "mesas",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-WV5OAHHB.js").then((m) => m.TablesComponent),
        title: "Mesas \u2014 Comanda \xDAnica"
      },
      {
        path: "cardapio",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-TM5YXORL.js").then((m) => m.MenuComponent),
        title: "Card\xE1pio \u2014 Comanda \xDAnica"
      },
      {
        path: "pedidos",
        loadComponent: () => import("./chunk-QXDPNMGJ.js").then((m) => m.PedidosComponent),
        title: "Pedidos \u2014 Comanda \xDAnica"
      },
      {
        path: "servicos",
        canActivate: [profileGuard(["OWNER", "ADMIN", "MANAGER", "CASHIER", "WAITER"])],
        loadComponent: () => import("./chunk-TI4H24JD.js").then((m) => m.ServicosComponent),
        title: "Servi\xE7os \u2014 Comanda \xDAnica"
      },
      {
        path: "financeiro",
        canActivate: [profileOrPlatformAdminGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-22CJKLHX.js").then((m) => m.ExtratoFinanceiroComponent),
        title: "Extrato Financeiro \u2014 Comanda \xDAnica"
      },
      {
        path: "financeiro-plataforma",
        canActivate: [platformAdminGuard],
        loadComponent: () => import("./chunk-XLIWR6BH.js").then((m) => m.FinanceiroPlataformaComponent),
        title: "Financeiro Comanda \xDAnica \u2014 Comanda \xDAnica"
      },
      {
        path: "funcionarios",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-4NFN37LB.js").then((m) => m.EmployeesComponent),
        title: "Funcion\xE1rios \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes",
        loadComponent: () => import("./chunk-MASDKDKU.js").then((m) => m.PlaceholderComponent),
        data: { title: "Configura\xE7\xF5es" },
        title: "Configura\xE7\xF5es \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/perfil",
        loadComponent: () => import("./chunk-DY53JNOI.js").then((m) => m.ProfileComponent),
        title: "Meu Perfil \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/redefinir-senha",
        loadComponent: () => import("./chunk-V6XUL5DL.js").then((m) => m.SecurityComponent),
        title: "Redefinir Senha \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/pagamentos",
        canActivate: [profileGuard(["OWNER", "ADMIN"])],
        loadComponent: () => import("./chunk-H3YEBAZ2.js").then((m) => m.OwnerStripePageComponent),
        title: "Pagamentos \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/stripe-plataforma",
        canActivate: [platformAdminGuard],
        loadComponent: () => import("./chunk-LRMPXSE3.js").then((m) => m.AdminStripeConfigPageComponent),
        title: "Stripe da Plataforma \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/mapa-salao",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-XVB3G32E.js").then((m) => m.FloorPlanListComponent),
        title: "Mapa do Sal\xE3o \u2014 Comanda \xDAnica"
      },
      {
        path: "configuracoes/mapa-salao/:id",
        canActivate: [profileGuard(["ADMIN", "OWNER", "MANAGER"])],
        loadComponent: () => import("./chunk-4WJRJID3.js").then((m) => m.FloorPlanEditorComponent),
        title: "Mapa do Sal\xE3o \u2014 Comanda \xDAnica"
      },
  ...
  {
    path: "termos-de-uso",
    loadComponent: () => import("./chunk-JKF62BNB.js").then((m) => m.TermsComponent),
    title: "Termos de Uso \u2014 Comanda \xDAnica"
  },
  {
    path: "politica-de-privacidade",
    loadComponent: () => import("./chunk-U7AOUSNX.js").then((m) => m.PrivacyComponent),
...
var App = class _App {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [["href", "#main-content", 1, "skip-link"]], template: function App_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "a", 0);
      \u0275\u0275text(1, "Pular para o conte\xFAdo");
      \u0275\u0275elementEnd();
