...
function TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 50);
    \u0275\u0275listener("click", function TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_38_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const table_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_39_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r11);
      const table_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_39_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r11);
      const table_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function TablesComponent_Conditional_13_Conditional_47_For_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_8_Template, 2, 1, "p", 42);
    ...
    \u0275\u0275listener("click", function TablesComponent_Conditional_13_Conditional_47_For_4_Template_button_click_26_listener() {
    ...
    \u0275\u0275listener("click", function TablesComponent_Conditional_13_Conditional_47_For_4_Template_button_click_29_listener() {
      const table_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function TablesComponent_Conditional_13_Conditional_47_For_4_Template_button_click_32_listener() {
      const table_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function TablesComponent_Conditional_13_Conditional_47_For_4_Template_button_click_35_listener() {
      const table_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(37, "print");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(38, TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_38_Template, 3, 1, "button", 49)(39, TablesComponent_Conditional_13_Conditional_47_For_4_Conditional_39_Template, 9, 2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(14);
    \u0275\u0275conditional(table_r9.operationalStatus === "CLEANING" ? 38 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.canManageTables() ? 39 : -1);
  }
}
function TablesComponent_Conditional_13_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(3, TablesComponent_Conditional_13_Conditional_47_For_4_Template, 40, 10, "div", 34, _forTrack0);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(ctx_r1.markCleanedError() ? 0 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.tables().length === 0 ? 2 : -1);
    \u0275\u0275advance();
...
function TablesComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r1.isLoadingList());
    \u0275\u0275advance(8);
...
function TablesComponent_Conditional_14_Conditional_2_For_15_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td", 56)(1, "button", 52);
...
function TablesComponent_Conditional_14_Conditional_2_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, TablesComponent_Conditional_14_Conditional_2_For_15_Conditional_8_Template, 7, 0, "td", 56);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TablesComponent_Conditional_14_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 53)(1, "div", 54)(2, "table", 55)(3, "thead")(4, "tr")(5, "th");
    \u0275\u0275text(6, "Setor");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th");
    \u0275\u0275text(8, "Ordem");
    ...
    \u0275\u0275text(10, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, TablesComponent_Conditional_14_Conditional_2_Conditional_11_Template, 2, 0, "th", 56);
    \u0275\u0275elementEnd()();
...
function TablesComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, TablesComponent_Conditional_14_Conditional_0_Template, 2, 0, "p", 31)(1, TablesComponent_Conditional_14_Conditional_1_Template, 4, 1, "div", 32)(2, TablesComponent_Conditional_14_Conditional_2_Template, 16, 2, "div", 53);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function TablesComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(9, "div", 64)(10, "div", 11)(11, "label", 65);
    \u0275\u0275text(12, "N\xFAmero da mesa");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 13);
    \u0275\u0275element(14, "input", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, TablesComponent_Conditional_15_Conditional_15_Template, 2, 0, "span", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 11)(17, "label", 68);
    \u0275\u0275text(18, "Nome/Apelido");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 13);
    \u0275\u0275element(20, "input", 69);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "div", 11)(22, "label", 70);
    \u0275\u0275text(23, "Setor");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 71)(25, "select", 72)(26, "option", 73);
    \u0275\u0275text(27, "Selecione um setor");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(28, TablesComponent_Conditional_15_For_29_Template, 2, 2, "option", 16, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275template(30, TablesComponent_Conditional_15_Conditional_30_Template, 4, 0, "button", 74);
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, TablesComponent_Conditional_15_Conditional_31_Template, 2, 0, "span", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "div", 64)(33, "div", 11)(34, "label", 75);
    \u0275\u0275text(35, "Capacidade");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 13);
    \u0275\u0275element(37, "input", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275template(38, TablesComponent_Conditional_15_Conditional_38_Template, 2, 0, "span", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 11)(40, "label", 77);
    \u0275\u0275text(41, "Status inicial");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "div", 13)(43, "select", 78)(44, "option", 20);
    \u0275\u0275text(45, "Ativa");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "option", 21);
    \u0275\u0275text(47, "Inativa");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(48, "div", 64)(49, "label", 79);
    \u0275\u0275element(50, "input", 80);
    \u0275\u0275text(51, " Permite QR Code");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "div", 11)(53, "label", 81);
    \u0275\u0275text(54, "Observa\xE7\xF5es");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "div", 13);
    \u0275\u0275element(56, "textarea", 82);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(57, TablesComponent_Conditional_15_Conditional_57_Template, 4, 1, "div", 32);
    \u0275\u0275elementStart(58, "div", 83)(59, "button", 84);
    \u0275\u0275text(60);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "button", 85);
...
function TablesComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 5)(1, "div", 87);
    ...
    \u0275\u0275elementStart(9, "div", 11)(10, "label", 88);
    \u0275\u0275text(11, "Nome");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 13);
    \u0275\u0275element(13, "input", 89);
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, TablesComponent_Conditional_16_Conditional_14_Template, 2, 0, "span", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 11)(16, "label", 90);
    \u0275\u0275text(17, "Ordem de exibi\xE7\xE3o");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 13);
    \u0275\u0275element(19, "input", 91);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 64)(21, "label", 79);
    \u0275\u0275element(22, "input", 92);
    \u0275\u0275text(23, " Ativo");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(24, TablesComponent_Conditional_16_Conditional_24_Template, 4, 1, "div", 32);
    \u0275\u0275elementStart(25, "div", 83)(26, "button", 84);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "button", 85);
...
function TablesComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(10, "div", 83)(11, "button", 93);
...
function TablesComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(11, "div", 83)(12, "button", 86);
...
var TablesComponent = class _TablesComponent {
  ...
  markingCleanedTableId = signal(null);
  markCleanedError = signal(null);
  ...
  toggleTableStatus(table) {
    ...
    request$.subscribe({
      ...
      error: () => {
        this.listError.set("N\xE3o foi poss\xEDvel atualizar o status da mesa.");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TablesComponent, { className: "TablesComponent", filePath: "src\\app\\features\\admin\\pages\\tables\\tables.component.ts", lineNumber: 48 });
})();
export {
  TablesComponent
};
//# sourceMappingURL=chunk-WV5OAHHB.js.map
