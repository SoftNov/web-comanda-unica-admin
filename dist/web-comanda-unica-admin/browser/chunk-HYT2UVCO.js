...
function ComandasComponent_Conditional_46_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_46_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_46_For_25_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 36);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_46_For_25_Conditional_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
...
function ComandasComponent_Conditional_46_For_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_46_For_25_Template_button_click_17_listener() {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(20, ComandasComponent_Conditional_46_For_25_Conditional_20_Template, 3, 1, "button", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ComandasComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(0, ComandasComponent_Conditional_46_Conditional_0_Template, 4, 1, "div", 23);
    ...
    \u0275\u0275template(23, ComandasComponent_Conditional_46_Conditional_23_Template, 3, 0, "tr");
    \u0275\u0275repeaterCreate(24, ComandasComponent_Conditional_46_For_25_Template, 21, 11, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 29)(27, "span", 30);
    \u0275\u0275text(28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 31)(30, "button", 20);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_46_Template_button_click_30_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_46_Template_button_click_34_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ComandasComponent_Conditional_47_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 53);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_47_Conditional_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
...
function ComandasComponent_Conditional_47_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_47_Conditional_35_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_47_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(3, "dd");
    \u0275\u0275text(4);
    \u0275\u0275template(5, ComandasComponent_Conditional_47_Conditional_35_Conditional_5_Template, 2, 1, "span", 54);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const comanda_r9 = \u0275\u0275nextContext();
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 66);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_31_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r13);
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 22);
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_7_Template, 2, 1, "span");
    \u0275\u0275elementStart(8, "span");
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_10_Template, 2, 1, "span", 68)(11, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_11_Template, 2, 1, "span", 69);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 67);
    \u0275\u0275repeaterCreate(1, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Template, 12, 9, "li", null, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const charge_r12 = \u0275\u0275nextContext(2).$implicit;
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 65)(1, "p", 22);
    \u0275\u0275text(2);
    \u0275\u0275template(3, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_3_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_4_Template, 2, 0, "p", 22)(5, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Conditional_5_Template, 3, 0, "ul", 67);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_16_0;
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Template_button_click_27_listener() {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_31_Template, 4, 0, "button", 64);
    \u0275\u0275elementEnd();
    \u0275\u0275template(32, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Conditional_32_Template, 6, 3, "div", 65);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_20_0;
...
function ComandasComponent_Conditional_47_Conditional_36_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 45)(1, "h3", 46);
    ...
    \u0275\u0275repeaterCreate(12, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_For_13_Template, 33, 15, "div", 57, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const fees_r10 = \u0275\u0275nextContext();
...
function ComandasComponent_Conditional_47_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ComandasComponent_Conditional_47_Conditional_36_Conditional_0_Template, 11, 1, "section", 45)(1, ComandasComponent_Conditional_47_Conditional_36_Conditional_1_Template, 14, 1, "section", 45);
  }
  if (rf & 2) {
    const fees_r10 = ctx;
...
function ComandasComponent_Conditional_47_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 22);
...
function ComandasComponent_Conditional_47_Conditional_41_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_47_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(15, ComandasComponent_Conditional_47_Conditional_41_For_16_Template, 12, 7, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const comanda_r9 = \u0275\u0275nextContext();
...
function ComandasComponent_Conditional_47_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 22);
...
function ComandasComponent_Conditional_47_Conditional_46_For_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_47_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "table", 70)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Quem pagou");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(17, ComandasComponent_Conditional_47_Conditional_46_For_18_Template, 13, 6, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const comanda_r9 = \u0275\u0275nextContext();
...
function ComandasComponent_Conditional_47_Conditional_47_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_47_Conditional_47_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_47_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("submit", function ComandasComponent_Conditional_47_Conditional_47_Template_form_submit_5_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, ComandasComponent_Conditional_47_Conditional_47_Conditional_12_Template, 2, 0, "span", 73);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(22, ComandasComponent_Conditional_47_Conditional_47_Conditional_22_Template, 4, 1, "div", 23);
...
function ComandasComponent_Conditional_47_Conditional_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_47_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r7);
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_47_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, ComandasComponent_Conditional_47_Conditional_12_Template, 4, 2, "button", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, ComandasComponent_Conditional_47_Conditional_13_Template, 4, 1, "div", 23);
    ...
    \u0275\u0275text(34);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(35, ComandasComponent_Conditional_47_Conditional_35_Template, 6, 2, "div");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(36, ComandasComponent_Conditional_47_Conditional_36_Template, 2, 2);
    \u0275\u0275elementStart(37, "section", 45)(38, "h3", 46);
    \u0275\u0275text(39, "Pedidos");
    \u0275\u0275elementEnd();
    \u0275\u0275template(40, ComandasComponent_Conditional_47_Conditional_40_Template, 2, 0, "p", 22)(41, ComandasComponent_Conditional_47_Conditional_41_Template, 17, 0, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "section", 45)(43, "h3", 46);
    \u0275\u0275text(44, "Pagamentos manuais");
    \u0275\u0275elementEnd();
    \u0275\u0275template(45, ComandasComponent_Conditional_47_Conditional_45_Template, 2, 0, "p", 22)(46, ComandasComponent_Conditional_47_Conditional_46_Template, 19, 0, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275template(47, ComandasComponent_Conditional_47_Conditional_47_Template, 26, 8, "section", 45);
    ...
    \u0275\u0275listener("submit", function ComandasComponent_Conditional_47_Template_form_submit_53_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      $event.preventDefault();
    ...
    \u0275\u0275text(63, "Encerrada");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(64, ComandasComponent_Conditional_47_Conditional_64_Template, 4, 1, "div", 23);
...
function ComandasComponent_Conditional_48_Conditional_2_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 73);
...
function ComandasComponent_Conditional_48_Conditional_2_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_48_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_48_Conditional_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("submit", function ComandasComponent_Conditional_48_Conditional_2_Template_form_submit_6_listener($event) {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(2);
      $event.preventDefault();
    ...
    \u0275\u0275listener("change", function ComandasComponent_Conditional_48_Conditional_2_Template_input_change_16_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("change", function ComandasComponent_Conditional_48_Conditional_2_Template_input_change_19_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(26, ComandasComponent_Conditional_48_Conditional_2_Conditional_26_Template, 2, 0, "span", 73);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(47, ComandasComponent_Conditional_48_Conditional_2_Conditional_47_Template, 4, 1, "div", 23);
    \u0275\u0275elementStart(48, "div", 51)(49, "button", 96);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_48_Conditional_2_Template_button_click_49_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.cancelRefundModal());
    });
...
function ComandasComponent_Conditional_48_Conditional_3_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_48_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(23, ComandasComponent_Conditional_48_Conditional_3_Conditional_23_Template, 4, 1, "div", 23);
    \u0275\u0275elementStart(24, "div", 51)(25, "button", 98);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_48_Conditional_3_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r21);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_48_Conditional_3_Template_button_click_27_listener() {
      \u0275\u0275restoreView(_r21);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function ComandasComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ComandasComponent_Conditional_48_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r18);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275template(2, ComandasComponent_Conditional_48_Conditional_2_Template, 53, 10)(3, ComandasComponent_Conditional_48_Conditional_3_Template, 29, 7);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var ComandasComponent = class _ComandasComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ComandasComponent, selectors: [["app-admin-comandas"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 49, vars: 9, consts: [[1, "page-header", "page-header--row"], [1, "page-title"], [1, "page-subtitle"], [1, "card", "filters-card"], [1, "filters-row"], [1, "field"], ["for", "filter-status", 1, "field__label"], [1, "field__control"], ["id", "filter-status", 1, "field__input", 3, "change", "value"], ["value", "all"], ["value", "OPEN"], ["value", "CLOSED"], ["for", "filter-table", 1, "field__label"], ["id", "filter-table", 1, "field__input", 3, "change", "value"], ["value", ""], [3, "value"], [1, "field", "filters-row__actions"], ["aria-hidden", "true", 1, "field__label"], ["type", "button", 1, "btn", "btn--ghost", "btn--sm", 3, "click", "title"], ["aria-hidden", "true", 1, "material-icons"], ["type", "button", 1, "btn", "btn--ghost", "btn--sm", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn--ghost", "btn--sm", 3, "click"], [1, "field__hint"], ["role", "alert", 1, "form-alert", "form-alert--error"], [1, "card", "table-card"], [1, "modal-backdrop"], [1, "table-wrapper"], [1, "data-table"], [1, "data-table__actions-col"], [1, "pagination"], [1, "pagination__info"], [1, "pagination__controls"], ["colspan", "8", 1, "data-table__empty"], [1, "badge"], ["type", "button", "title", "Ver detalhes", 1, "icon-btn", 3, "click"], ["type", "button", "title", "Finalizar comanda (saldo zerado)", 1, "icon-btn", "icon-btn--success", 3, "disabled"], ["type", "button", "title", "Finalizar comanda (saldo zerado)", 1, "icon-btn", "icon-btn--success", 3, "click", "disabled"], [1, "modal-card", "modal-card--lg", "card", 3, "click"], [1, "modal-card__header"], [1, "step-heading"], ["type", "button", "aria-label", "Fechar", 1, "icon-btn", 3, "click"], [1, "comanda-summary"], [1, "comanda-summary__status"], ["type", "button", 1, "btn", "btn--success", "btn--sm", 3, "disabled"], [1, "comanda-summary__stats"], [1, "comanda-section"], [1, "comanda-section__title"], ["novalidate", "", 3, "submit", "formGroup"], [1, "field__row"], ["for", "comanda-status", 1, "field__label"], ["id", "comanda-status", "formControlName", "status", 1, "field__input"], [1, "step-actions"], ["type", "submit", 1, "btn", "btn--ghost", 3, "disabled"], ["type", "button", 1, "btn", "btn--success", "btn--sm", 3, "click", "disabled"], [1, "comanda-summary__by"], [1, "comanda-fees"], [1, "payment-cards"], [1, "payment-card", 3, "payment-card--refundable"], [1, "payment-card"], [1, "payment-card__header"], [1, "payment-card__method"], [1, "payment-card__meta"], [1, "payment-card__stats"], [1, "payment-card__actions"], ["type", "button", 1, "btn", "btn--danger", "btn--sm"], [1, "charge-details"], ["type", "button", 1, "btn", "btn--danger", "btn--sm", 3, "click"], [1, "refund-history"], [1, "refund-history__description"], [1, "refund-history__description", "refund-history__description--error"], [1, "data-table", "data-table--compact"], ["for", "payment-amount", 1, "field__label"], ["id", "payment-amount", "type", "number", "min", "0.01", "step", "0.01", "formControlName", "amount", "placeholder", "0,00", 1, "field__input"], [1, "field__error"], ["for", "payment-method", 1, "field__label"], ["id", "payment-method", "formControlName", "method", 1, "field__input"], ["value", "CASH_REGISTER"], ["value", "CASH_WAITER"], ["type", "submit", "appRipple", "", 1, "btn", "btn--primary", 3, "disabled"], [1, "modal-card", "card", 3, "click"], [1, "field__label"], [1, "refund-type-options"], [1, "refund-type-option"], ["type", "radio", "name", "refund-type", "value", "TOTAL", 3, "change", "checked"], ["type", "radio", "name", "refund-type", "value", "PARTIAL", 3, "change", "checked"], ["for", "refund-amount", 1, "field__label"], ["id", "refund-amount", "type", "number", "min", "0.01", "step", "0.01", "formControlName", "amount", "placeholder", "0,00", 1, "field__input", 3, "max", "readOnly"], ["for", "refund-reason", 1, "field__label"], ["id", "refund-reason", "formControlName", "reason", 1, "field__input"], ["value", "CUSTOMER_REQUEST"], ["value", "ORDER_CANCELLED"], ["value", "DUPLICATE_CHARGE"], ["value", "OPERATIONAL_ERROR"], ["value", "OTHER"], ["for", "refund-description", 1, "field__label"], ["id", "refund-description", "rows", "2", "maxlength", "500", "formControlName", "description", 1, "field__input"], ["type", "button", 1, "btn", "btn--ghost", 3, "click"], ["type", "submit", 1, "btn", "btn--danger"], ["type", "button", 1, "btn", "btn--ghost", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn--danger", 3, "click", "disabled"]], template: function ComandasComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(44, ComandasComponent_Conditional_44_Template, 2, 0, "p", 22)(45, ComandasComponent_Conditional_45_Template, 4, 1, "div", 23)(46, ComandasComponent_Conditional_46_Template, 38, 6, "div", 24)(47, ComandasComponent_Conditional_47_Template, 68, 20, "div", 25)(48, ComandasComponent_Conditional_48_Template, 4, 1, "div", 25);
    }
    if (rf & 2) {
      let tmp_0_0;
      let tmp_8_0;
      ...
      \u0275\u0275advance(8);
      \u0275\u0275conditional(ctx.isLoadingList() ? 44 : ctx.listError() ? 45 : 46);
      \u0275\u0275advance(3);
      \u0275\u0275conditional((tmp_8_0 = ctx.selectedComanda()) ? 47 : -1, tmp_8_0);
      \u0275\u0275advance();
      \u0275\u0275conditional((tmp_9_0 = ctx.chargeToRefund()) ? 48 : -1, tmp_9_0);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ComandasComponent, { className: "ComandasComponent", filePath: "src\\app\\features\\admin\\pages\\comandas\\comandas.component.ts", lineNumber: 37 });
})();
export {
  ComandasComponent
};
//# sourceMappingURL=chunk-HYT2UVCO.js.map
