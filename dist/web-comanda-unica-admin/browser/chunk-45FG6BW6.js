...
function ComandasComponent_Conditional_48_For_25_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Reserva de ", comanda_r5.guestName, "");
  }
}
function ComandasComponent_Conditional_48_For_25_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 37);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_48_For_25_Conditional_21_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const comanda_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function ComandasComponent_Conditional_48_For_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275template(3, ComandasComponent_Conditional_48_For_25_Conditional_3_Template, 2, 1, "span", 33);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "td", 28)(18, "button", 35);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_48_For_25_Template_button_click_18_listener() {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(21, ComandasComponent_Conditional_48_For_25_Conditional_21_Template, 3, 1, "button", 36);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(comanda_r5.guestName ? 3 : -1);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r1.canFinalize(comanda_r5) ? 21 : -1);
  }
}
function ComandasComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(24, ComandasComponent_Conditional_48_For_25_Template, 22, 12, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()()();
...
function ComandasComponent_Conditional_49_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const comanda_r8 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Aberta pela reserva de ", comanda_r8.guestName, "");
  }
}
function ComandasComponent_Conditional_49_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 55);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_49_Conditional_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const comanda_r8 = \u0275\u0275nextContext();
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.finalizeComanda(comanda_r8));
    });
    \u0275\u0275elementStart(1, "span", 19);
    \u0275\u0275text(2, "check_circle");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const comanda_r8 = \u0275\u0275nextContext();
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("disabled", ctx_r1.finalizingComandaId() === comanda_r8.id);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.finalizingComandaId() === comanda_r8.id ? "Finalizando\u2026" : "Finalizar comanda", " ");
  }
}
function ComandasComponent_Conditional_49_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_49_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46)(1, "dt");
    \u0275\u0275text(2, "Desconto da plataforma");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "dd");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("-", ctx_r1.formatCurrency(comanda_r8.discountAmount), "");
  }
}
function ComandasComponent_Conditional_49_Conditional_38_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const comanda_r8 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("por ", comanda_r8.closedByUserName, "");
  }
}
function ComandasComponent_Conditional_49_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(3, "dd");
    \u0275\u0275text(4);
    \u0275\u0275template(5, ComandasComponent_Conditional_49_Conditional_38_Conditional_5_Template, 2, 1, "span", 56);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const comanda_r8 = \u0275\u0275nextContext();
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatDateTime(comanda_r8.closedAt), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(comanda_r8.closedByUserName ? 5 : -1);
  }
}
function ComandasComponent_Conditional_49_Conditional_39_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 47)(1, "h3", 48);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "dl", 57)(6, "div")(7, "dt");
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 68);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_31_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r13);
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 22);
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_7_Template, 2, 1, "span");
    \u0275\u0275elementStart(8, "span");
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_10_Template, 2, 1, "span", 70)(11, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Conditional_11_Template, 2, 1, "span", 71);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 69);
    \u0275\u0275repeaterCreate(1, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_For_2_Template, 12, 9, "li", null, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const charge_r12 = \u0275\u0275nextContext(2).$implicit;
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 67)(1, "p", 22);
    \u0275\u0275text(2);
    \u0275\u0275template(3, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_3_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_4_Template, 2, 0, "p", 22)(5, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Conditional_5_Template, 3, 0, "ul", 69);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_16_0;
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 60)(1, "div", 61)(2, "span", 62)(3, "span", 19);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "dl", 64)(11, "div")(12, "dt");
    ...
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 65)(27, "button", 21);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Template_button_click_27_listener() {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_31_Template, 4, 0, "button", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275template(32, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Conditional_32_Template, 6, 3, "div", 67);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_20_0;
...
function ComandasComponent_Conditional_49_Conditional_39_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 47)(1, "h3", 48);
    ...
    \u0275\u0275repeaterCreate(12, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_For_13_Template, 33, 15, "div", 59, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const fees_r10 = \u0275\u0275nextContext();
...
function ComandasComponent_Conditional_49_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ComandasComponent_Conditional_49_Conditional_39_Conditional_0_Template, 11, 1, "section", 47)(1, ComandasComponent_Conditional_49_Conditional_39_Conditional_1_Template, 14, 1, "section", 47);
  }
  if (rf & 2) {
    const fees_r10 = ctx;
...
function ComandasComponent_Conditional_49_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 22);
...
function ComandasComponent_Conditional_49_Conditional_44_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_49_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "table", 72)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Cliente");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "Itens");
    ...
    \u0275\u0275repeaterCreate(15, ComandasComponent_Conditional_49_Conditional_44_For_16_Template, 12, 7, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const comanda_r8 = \u0275\u0275nextContext();
    \u0275\u0275advance(15);
    \u0275\u0275repeater(comanda_r8.orders);
  }
}
function ComandasComponent_Conditional_49_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 22);
...
function ComandasComponent_Conditional_49_Conditional_49_For_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_49_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "table", 72)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Quem pagou");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(17, ComandasComponent_Conditional_49_Conditional_49_For_18_Template, 13, 6, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const comanda_r8 = \u0275\u0275nextContext();
    \u0275\u0275advance(17);
    \u0275\u0275repeater(comanda_r8.payments);
  }
}
function ComandasComponent_Conditional_49_Conditional_50_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("J\xE1 inclui desconto da plataforma de ", ctx_r1.formatCurrency(comanda_r8.discountAmount), ".");
  }
}
function ComandasComponent_Conditional_49_Conditional_50_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
...
function ComandasComponent_Conditional_49_Conditional_50_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_49_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "form", 49);
    \u0275\u0275listener("submit", function ComandasComponent_Conditional_49_Conditional_50_Template_form_submit_5_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r1 = \u0275\u0275nextContext(2);
      $event.preventDefault();
      return \u0275\u0275resetView(ctx_r1.submitPayment());
    });
    \u0275\u0275elementStart(6, "div", 50)(7, "div", 5)(8, "label", 73);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 7);
    \u0275\u0275element(11, "input", 74);
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, ComandasComponent_Conditional_49_Conditional_50_Conditional_12_Template, 2, 1, "span", 22)(13, ComandasComponent_Conditional_49_Conditional_50_Conditional_13_Template, 2, 0, "span", 75);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 5)(15, "label", 76);
    \u0275\u0275text(16, "Onde foi pago");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 7)(18, "select", 77)(19, "option", 78);
    \u0275\u0275text(20, "Dinheiro no caixa");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "option", 79);
    \u0275\u0275text(22, "Dinheiro com o gar\xE7om");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(23, ComandasComponent_Conditional_49_Conditional_50_Conditional_23_Template, 4, 1, "div", 23);
    \u0275\u0275elementStart(24, "div", 53)(25, "button", 80);
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("Valor a cobrar (saldo: ", ctx_r1.formatCurrency(comanda_r8.amountToCollect), ")");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("field__input--invalid", ctx_r1.paymentForm.controls.amount.invalid && ctx_r1.paymentForm.controls.amount.touched);
    \u0275\u0275advance();
    \u0275\u0275conditional(comanda_r8.discountAmount > 0 ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.paymentForm.controls.amount.invalid && ctx_r1.paymentForm.controls.amount.touched ? 13 : -1);
    \u0275\u0275advance(10);
    \u0275\u0275conditional(ctx_r1.paymentError() ? 23 : -1);
    \u0275\u0275advance(2);
...
function ComandasComponent_Conditional_49_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 19);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function ComandasComponent_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 25)(1, "div", 38);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_49_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r7);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 39)(3, "div")(4, "h2", 40);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, ComandasComponent_Conditional_49_Conditional_6_Template, 2, 1, "p", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 41);
    \u0275\u0275listener("click", function ComandasComponent_Conditional_49_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(9, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 42)(11, "div", 43)(12, "span", 34);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, ComandasComponent_Conditional_49_Conditional_14_Template, 4, 2, "button", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, ComandasComponent_Conditional_49_Conditional_15_Template, 4, 1, "div", 23);
    \u0275\u0275elementStart(16, "dl", 45)(17, "div")(18, "dt");
    \u0275\u0275text(19, "Total pedidos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "dd");
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div")(23, "dt");
    \u0275\u0275text(24, "Total pago");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(32, ComandasComponent_Conditional_49_Conditional_32_Template, 5, 1, "div", 46);
    ...
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(38, ComandasComponent_Conditional_49_Conditional_38_Template, 6, 2, "div");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(39, ComandasComponent_Conditional_49_Conditional_39_Template, 2, 2);
    \u0275\u0275elementStart(40, "section", 47)(41, "h3", 48);
    \u0275\u0275text(42, "Pedidos");
    \u0275\u0275elementEnd();
    \u0275\u0275template(43, ComandasComponent_Conditional_49_Conditional_43_Template, 2, 0, "p", 22)(44, ComandasComponent_Conditional_49_Conditional_44_Template, 17, 0, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "section", 47)(46, "h3", 48);
    \u0275\u0275text(47, "Pagamentos manuais");
    \u0275\u0275elementEnd();
    \u0275\u0275template(48, ComandasComponent_Conditional_49_Conditional_48_Template, 2, 0, "p", 22)(49, ComandasComponent_Conditional_49_Conditional_49_Template, 19, 0, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275template(50, ComandasComponent_Conditional_49_Conditional_50_Template, 27, 9, "section", 47);
    \u0275\u0275elementStart(51, "section", 47)(52, "h3", 48);
    \u0275\u0275text(53, "Alterar status manualmente");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "p", 22);
    \u0275\u0275text(55, "Sobrep\xF5e o fluxo autom\xE1tico \u2014 use apenas em situa\xE7\xF5es excepcionais (ex: comanda que deveria ter sido encerrada e n\xE3o foi).");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "form", 49);
    \u0275\u0275listener("submit", function ComandasComponent_Conditional_49_Template_form_submit_56_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      $event.preventDefault();
      return \u0275\u0275resetView(ctx_r1.submitStatusChange());
    });
    \u0275\u0275elementStart(57, "div", 50)(58, "div", 5)(59, "label", 51);
    \u0275\u0275text(60, "Novo status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "div", 7)(62, "select", 52)(63, "option", 10);
    \u0275\u0275text(64, "Em aberto");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "option", 11);
    \u0275\u0275text(66, "Encerrada");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(67, ComandasComponent_Conditional_49_Conditional_67_Template, 4, 1, "div", 23);
    \u0275\u0275elementStart(68, "div", 53)(69, "button", 54);
    \u0275\u0275text(70);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    let tmp_14_0;
    const comanda_r8 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" Comanda \u2014 Mesa ", comanda_r8.tableNumber, "", comanda_r8.tableName ? " \u2014 " + comanda_r8.tableName : "", " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(comanda_r8.guestName ? 6 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275classMap(ctx_r1.displayStatusBadgeClass(comanda_r8.displayStatus));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.displayStatusLabel(comanda_r8.displayStatus), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.canFinalize(comanda_r8) ? 14 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.finalizeError() ? 15 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(comanda_r8.totalOrdersAmount));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(comanda_r8.totalPaidAmount));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(comanda_r8.balanceAmount));
    \u0275\u0275advance();
    \u0275\u0275conditional(comanda_r8.discountAmount > 0 ? 32 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatDateTime(comanda_r8.openedAt));
    \u0275\u0275advance();
    \u0275\u0275conditional(comanda_r8.closedAt ? 38 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_14_0 = comanda_r8.fees) ? 39 : -1, tmp_14_0);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(comanda_r8.orders.length === 0 ? 43 : 44);
    \u0275\u0275advance(5);
    \u0275\u0275conditional(comanda_r8.payments.length === 0 ? 48 : 49);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(comanda_r8.status === "OPEN" ? 50 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275property("formGroup", ctx_r1.statusForm);
    \u0275\u0275advance(11);
    \u0275\u0275conditional(ctx_r1.statusError() ? 67 : -1);
    \u0275\u0275advance(2);
...
function ComandasComponent_Conditional_50_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 5)(12, "label", 82);
    \u0275\u0275text(13, "Tipo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 83)(15, "label", 84)(16, "input", 85);
    ...
    \u0275\u0275text(17, " Total ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "label", 84)(19, "input", 86);
    ...
    \u0275\u0275text(20, " Parcial ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "div", 5)(22, "label", 87);
    \u0275\u0275text(23, "Valor");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 7);
    \u0275\u0275element(25, "input", 88);
    \u0275\u0275elementEnd();
    \u0275\u0275template(26, ComandasComponent_Conditional_50_Conditional_2_Conditional_26_Template, 2, 0, "span", 75);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 5)(28, "label", 89);
    \u0275\u0275text(29, "Motivo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 7)(31, "select", 90)(32, "option", 91);
    \u0275\u0275text(33, "Solicita\xE7\xE3o do cliente");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "option", 92);
    \u0275\u0275text(35, "Pedido cancelado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "option", 93);
    \u0275\u0275text(37, "Cobran\xE7a duplicada");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "option", 94);
    \u0275\u0275text(39, "Erro operacional");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "option", 95);
    \u0275\u0275text(41, "Outro");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(42, "div", 5)(43, "label", 96);
    \u0275\u0275text(44, "Observa\xE7\xE3o (opcional)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "div", 7);
    \u0275\u0275element(46, "textarea", 97);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(47, ComandasComponent_Conditional_50_Conditional_2_Conditional_47_Template, 4, 1, "div", 23);
    \u0275\u0275elementStart(48, "div", 53)(49, "button", 98);
...
function ComandasComponent_Conditional_50_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "dl", 45)(6, "div")(7, "dt");
    \u0275\u0275text(8, "M\xE9todo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "dd");
    \u0275\u0275text(10);
    ...
    \u0275\u0275elementStart(24, "div", 53)(25, "button", 100);
...
function ComandasComponent_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 25)(1, "div", 81);
...
//# sourceMappingURL=chunk-45FG6BW6.js.map
