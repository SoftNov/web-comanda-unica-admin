...
var PedidosComponent = class _PedidosComponent {
  ...
  connectRealtimeQueue() {
    ...
    this.queueSubscription = this.orderQueueService.connectRealtime(companyId, token, this.sectorFilter() || void 0).pipe(retry({
      delay: (_, retryCount) => {
...
//# sourceMappingURL=chunk-A2GRAGZF.js.map
