...
} from "./chunk-LZEK36UG.js";
import {
  resolveHomeRoute
} from "./chunk-YF6K64HC.js";
import {
  OrderQueueService
} from "./chunk-6PWAKQUK.js";
import "./chunk-GUJOAOKJ.js";
import {
  AuthService
...
function AdminLayoutComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, AdminLayoutComponent_Conditional_24_Conditional_8_Template, 3, 0, "div", 51);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminLayoutComponent, { className: "AdminLayoutComponent", filePath: "src\\app\\features\\admin\\layout\\admin-layout\\admin-layout.component.ts", lineNumber: 23 });
})();
export {
  AdminLayoutComponent
};
//# sourceMappingURL=chunk-ONDVEUD3.js.map
