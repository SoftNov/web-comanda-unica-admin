...
var _forTrack1 = ($index, $item) => $item.days;
...
function DashboardComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, DashboardComponent_Conditional_5_For_2_Template, 4, 5, "button", 5, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DashboardComponent_Conditional_6_For_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 37);
    \u0275\u0275listener("click", function DashboardComponent_Conditional_6_For_24_Template_button_click_0_listener() {
...
function DashboardComponent_Conditional_6_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "span", 7);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function DashboardComponent_Conditional_6_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_Conditional_6_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-line-chart", 26);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function DashboardComponent_Conditional_6_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "span", 7);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function DashboardComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 12)(6, "div", 13)(7, "span", 14);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span", 15);
    \u0275\u0275text(10, "faturado no per\xEDodo");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 13)(12, "span", 16);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "span", 15);
    \u0275\u0275text(15, "l\xEDquido recebido");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 13)(17, "span", 14);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "span", 15);
    \u0275\u0275text(20, "saldo dispon\xEDvel na Stripe");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(21, "div", 17)(22, "div", 18);
    \u0275\u0275repeaterCreate(23, DashboardComponent_Conditional_6_For_24_Template, 2, 3, "button", 19, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 20)(26, "label", 21)(27, "span");
    \u0275\u0275text(28, "De");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "input", 22);
    \u0275\u0275listener("change", function DashboardComponent_Conditional_6_Template_input_change_29_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onRevenueStartDateChange($event.target.value));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "label", 21)(31, "span");
    \u0275\u0275text(32, "At\xE9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "input", 23);
    \u0275\u0275listener("change", function DashboardComponent_Conditional_6_Template_input_change_33_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onRevenueEndDateChange($event.target.value));
    });
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(34, DashboardComponent_Conditional_6_Conditional_34_Template, 4, 1, "div", 24)(35, DashboardComponent_Conditional_6_Conditional_35_Template, 2, 0, "p", 25)(36, DashboardComponent_Conditional_6_Conditional_36_Template, 1, 3, "app-line-chart", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 27)(38, "div", 28)(39, "h2", 29);
    \u0275\u0275text(40, "Opera\xE7\xE3o");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "span", 30);
    \u0275\u0275element(42, "span", 31);
    \u0275\u0275text(43);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(44, DashboardComponent_Conditional_6_Conditional_44_Template, 4, 1, "div", 24);
    \u0275\u0275elementStart(45, "div", 32)(46, "div", 33)(47, "span", 34);
    \u0275\u0275text(48, "receipt_long");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "span", 35);
    \u0275\u0275text(50, "Comandas abertas");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(78, "Funcion\xE1rios ativos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "span", 36);
    \u0275\u0275text(80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(81, "div", 33)(82, "span", 34);
    \u0275\u0275text(83, "payments");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(84, "span", 35);
    \u0275\u0275text(85, "Valor em comandas abertas");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "span", 36);
    \u0275\u0275text(87);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(88, "div", 33)(89, "span", 34);
    \u0275\u0275text(90, "point_of_sale");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "span", 35);
    \u0275\u0275text(92, "Pedidos feitos hoje");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "span", 36);
    \u0275\u0275text(94);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(95, "div", 33)(96, "span", 34);
    \u0275\u0275text(97, "shopping_cart");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(98, "span", 35);
    \u0275\u0275text(99, "Itens no carrinho");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", ctx_r2.isLoadingStripeBalance() ? "\u2014" : ctx_r2.stripeBalance() != null ? ctx_r2.formatCurrency(ctx_r2.stripeBalance()) : "\u2014", " ");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.revenueError() ? 34 : ctx_r2.isLoadingRevenue() ? 35 : 36);
    \u0275\u0275advance(7);
    \u0275\u0275classProp("live-indicator--error", ctx_r2.summaryError());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r2.summaryError() ? "Reconectando\u2026" : "Ao vivo", " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.summaryError() ? 44 : -1);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : (tmp_13_0 = ctx_r2.summary()) == null ? null : tmp_13_0.openComandas);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : (tmp_14_0 = ctx_r2.summary()) == null ? null : tmp_14_0.occupiedTables);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : (tmp_15_0 = ctx_r2.summary()) == null ? null : tmp_15_0.freeTables);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : (tmp_16_0 = ctx_r2.summary()) == null ? null : tmp_16_0.cleaningTables);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : (tmp_17_0 = ctx_r2.summary()) == null ? null : tmp_17_0.activeEmployees);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : ctx_r2.formatCurrency((tmp_18_0 = ctx_r2.summary()) == null ? null : tmp_18_0.openComandasValue));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : ctx_r2.formatCurrency((tmp_19_0 = ctx_r2.summary()) == null ? null : tmp_19_0.ordersValueToday));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r2.isLoadingSummary() ? "\u2014" : (tmp_20_0 = ctx_r2.summary()) == null ? null : tmp_20_0.openCartItemsCount);
  }
}
...
function DashboardComponent_Conditional_9_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, DashboardComponent_Conditional_9_Conditional_4_For_2_Template, 2, 3, "button", 42, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function DashboardComponent_Conditional_9_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-floor-plan-viewer", 41);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function DashboardComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "div", 38)(2, "h2", 39);
    \u0275\u0275text(3, "Mapa do estabelecimento");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, DashboardComponent_Conditional_9_Conditional_4_Template, 3, 0, "div", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, DashboardComponent_Conditional_9_Conditional_5_Template, 2, 0, "p", 25)(6, DashboardComponent_Conditional_9_Conditional_6_Template, 1, 1, "app-floor-plan-viewer", 41)(7, DashboardComponent_Conditional_9_Conditional_7_Template, 2, 0, "p", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
//# sourceMappingURL=chunk-5HHJGK6J.js.map
