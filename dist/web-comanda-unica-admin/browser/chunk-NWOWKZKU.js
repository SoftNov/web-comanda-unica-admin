...
var AdminLayoutComponent = class _AdminLayoutComponent {
  ...
  filterMenuByProfile(items, profileCode) {
    return items.filter((item) => !item.roles || !!profileCode && item.roles.includes(profileCode)).map((item) => item.children ? __spreadProps(__spreadValues({}, item), { children: this.filterMenuByProfile(item.children, profileCode) }) : item);
  }
  syncProfileImages() {
...
//# sourceMappingURL=chunk-NWOWKZKU.js.map
