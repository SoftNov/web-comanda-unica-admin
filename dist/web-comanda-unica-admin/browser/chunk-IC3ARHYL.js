import {
  ...
  require_lib
} from "./chunk-5BWTIZHA.js";
import {
  FloorPlansService
} from "./chunk-LXW5U2SF.js";
import {
  PedidosComponent
} from "./chunk-72B3VHPC.js";
import {
  ServicosComponent
} from "./chunk-YDCE6FW2.js";
import {
  TablesService
} from "./chunk-FMMT5MXF.js";
import "./chunk-JD6JJHYZ.js";
import "./chunk-3P5ASN3M.js";
import "./chunk-PUSDOZ43.js";
import "./chunk-7XMVMANI.js";
import {
  webSocket
} from "./chunk-WARJUP3R.js";
import {
  SubscriptionService
...
// src/app/shared/components/subscription-banner/subscription-banner.component.ts
function SubscriptionBannerComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const b_r1 = ctx;
    \u0275\u0275classProp("sub-banner--warn", b_r1.tone === "warn");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r1.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r1.text);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r1.cta);
  }
}
var SubscriptionBannerComponent = class _SubscriptionBannerComponent {
  ...
  banner = computed(() => {
    ...
    if (s.courtesyTableLimitExceeded) {
      return {
        text: `O per\xEDodo gr\xE1tis permite at\xE9 ${s.courtesyTableLimit} mesas \u2014 voc\xEA tem ${s.tableCount}. Assine para continuar.`,
        cta: "Assinar",
        icon: "block",
        tone: "warn"
      };
    ...
    if (s.status === "PAST_DUE") {
      return {
        text: "O pagamento da assinatura n\xE3o foi conclu\xEDdo. Regularize para n\xE3o perder o acesso.",
        cta: "Regularizar",
        icon: "warning_amber",
        tone: "warn"
      };
    ...
    if (s.courtesy) {
      ...
      const days = end ? Math.max(0, Math.ceil((end.getTime() - Date.now()) / 864e5)) : null;
      return {
        text: days != null ? `Voc\xEA est\xE1 no per\xEDodo de cortesia \u2014 faltam ${days} dia(s). Assine para continuar usando a Comanda \xDAnica.` : "Voc\xEA est\xE1 no per\xEDodo de cortesia. Assine para continuar usando a Comanda \xDAnica.",
        cta: "Assinar",
        icon: "schedule",
        tone: "warn"
      };
    ...
    if (!s.active) {
      return {
        text: "Ative sua assinatura da Comanda \xDAnica para usar todos os recursos do painel.",
        cta: "Assinar agora",
    ...
    if (s.planOutdated) {
      return {
        text: "Voc\xEA mudou de faixa de mesas \u2014 o valor da assinatura est\xE1 desatualizado.",
        cta: "Atualizar plano",
        icon: "upgrade",
        tone: "info"
      };
  ...
  static \u0275fac = function SubscriptionBannerComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SubscriptionBannerComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SubscriptionBannerComponent, selectors: [["app-subscription-banner"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [[1, "sub-banner", 3, "sub-banner--warn"], [1, "sub-banner"], ["aria-hidden", "true", 1, "material-icons"], [1, "sub-banner__text"], ["routerLink", "/painel/assinatura", 1, "sub-banner__cta"]], template: function SubscriptionBannerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, SubscriptionBannerComponent_Conditional_0_Template, 7, 5, "div", 0);
    }
    if (rf & 2) {
      let tmp_0_0;
      \u0275\u0275conditional((tmp_0_0 = ctx.banner()) ? 0 : -1, tmp_0_0);
    }
  }, dependencies: [RouterLink], styles: ["\n\n.sub-banner[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 12px 16px;\n  margin-bottom: 20px;\n  border-radius: var(--radius-sm);\n  background: var(--color-accent-bg);\n  border: 1px solid rgba(59, 130, 246, 0.28);\n  color: var(--color-text);\n  font-size: 0.9rem;\n}\n.sub-banner--warn[_ngcontent-%COMP%] {\n  background: rgba(214, 164, 79, 0.14);\n  border-color: rgba(214, 164, 79, 0.4);\n}\n.sub-banner[_ngcontent-%COMP%]   .material-icons[_ngcontent-%COMP%] {\n  font-size: 20px;\n  color: var(--color-accent-hover);\n  flex-shrink: 0;\n}\n.sub-banner--warn[_ngcontent-%COMP%]   .material-icons[_ngcontent-%COMP%] {\n  color: #d6a44f;\n}\n.sub-banner__text[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.sub-banner__cta[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n  font-weight: 600;\n  color: var(--color-accent-hover);\n  text-decoration: none;\n  white-space: nowrap;\n}\n.sub-banner__cta[_ngcontent-%COMP%]:hover {\n  text-decoration: underline;\n}\n/*# sourceMappingURL=subscription-banner.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SubscriptionBannerComponent, { className: "SubscriptionBannerComponent", filePath: "src\\app\\shared\\components\\subscription-banner\\subscription-banner.component.ts", lineNumber: 64 });
})();
...
function DashboardComponent_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_Conditional_6_For_2_Template_button_click_0_listener() {
...
function DashboardComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, DashboardComponent_Conditional_6_For_2_Template, 4, 5, "button", 5, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DashboardComponent_Conditional_7_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_Conditional_7_For_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 40);
    \u0275\u0275listener("click", function DashboardComponent_Conditional_7_For_31_Template_button_click_0_listener() {
...
function DashboardComponent_Conditional_7_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_Conditional_7_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_Conditional_7_Conditional_47_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_Conditional_7_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28);
    \u0275\u0275template(1, DashboardComponent_Conditional_7_Conditional_47_Conditional_1_Template, 2, 0, "div", 41);
...
function DashboardComponent_Conditional_7_Conditional_48_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 27);
...
function DashboardComponent_Conditional_7_Conditional_48_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_Conditional_7_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "h2", 11);
    \u0275\u0275text(2, "Saldo acumulado no per\xEDodo");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, DashboardComponent_Conditional_7_Conditional_48_Conditional_3_Template, 2, 0, "p", 27)(4, DashboardComponent_Conditional_7_Conditional_48_Conditional_4_Template, 1, 2, "app-line-chart", 44);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function DashboardComponent_Conditional_7_Conditional_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "span", 7);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function DashboardComponent_Conditional_7_Conditional_121_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "span", 37);
    \u0275\u0275text(2, "card_giftcard");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 38);
    \u0275\u0275text(4, "Cr\xE9dito da assinatura dispon\xEDvel");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r2.formatCurrency(ctx_r2.subscriptionCreditAvailable()));
  }
}
function DashboardComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, DashboardComponent_Conditional_7_Conditional_5_Template, 2, 0, "span", 12);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(27, DashboardComponent_Conditional_7_Conditional_27_Template, 15, 3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 18)(29, "div", 19);
    \u0275\u0275repeaterCreate(30, DashboardComponent_Conditional_7_For_31_Template, 2, 3, "button", 20, _forTrack12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "div", 21)(33, "label", 22)(34, "span");
    \u0275\u0275text(35, "De");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "input", 23);
    \u0275\u0275listener("change", function DashboardComponent_Conditional_7_Template_input_change_36_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("change", function DashboardComponent_Conditional_7_Template_input_change_40_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function DashboardComponent_Conditional_7_Template_button_click_41_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(44);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(45, DashboardComponent_Conditional_7_Conditional_45_Template, 4, 1, "div", 26)(46, DashboardComponent_Conditional_7_Conditional_46_Template, 2, 0, "p", 27)(47, DashboardComponent_Conditional_7_Conditional_47_Template, 3, 4, "div", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275template(48, DashboardComponent_Conditional_7_Conditional_48_Template, 5, 1, "div", 29);
    ...
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(56, DashboardComponent_Conditional_7_Conditional_56_Template, 4, 1, "div", 26);
    ...
    \u0275\u0275text(120);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(121, DashboardComponent_Conditional_7_Conditional_121_Template, 7, 1, "div", 36);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_19_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.subscriptionCreditAvailable() != null ? 121 : -1);
  }
}
...
function DashboardComponent_Conditional_10_Conditional_4_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 50);
    \u0275\u0275listener("click", function DashboardComponent_Conditional_10_Conditional_4_For_2_Template_button_click_0_listener() {
...
function DashboardComponent_Conditional_10_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47);
    \u0275\u0275repeaterCreate(1, DashboardComponent_Conditional_10_Conditional_4_For_2_Template, 2, 3, "button", 49, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function DashboardComponent_Conditional_10_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 27);
...
function DashboardComponent_Conditional_10_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_Conditional_10_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 27);
...
function DashboardComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, DashboardComponent_Conditional_10_Conditional_4_Template, 3, 0, "div", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, DashboardComponent_Conditional_10_Conditional_5_Template, 2, 0, "p", 27)(6, DashboardComponent_Conditional_10_Conditional_6_Template, 1, 1, "app-floor-plan-viewer", 48)(7, DashboardComponent_Conditional_10_Conditional_7_Template, 2, 0, "p", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var DashboardComponent = class _DashboardComponent {
  ...
  subscriptionCreditAvailable = computed(() => this.subscriptionService.status()?.credit?.available ?? null);
  currencyFormatter = new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL" });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-admin-dashboard"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 11, vars: 7, consts: [[1, "page-header"], [1, "page-title"], [1, "page-subtitle"], ["role", "tablist", 1, "dashboard-tabs"], [1, "card", "floor-plan-section"], ["type", "button", "role", "tab", 1, "dashboard-tabs__tab", 3, "dashboard-tabs__tab--active"], ["type", "button", "role", "tab", 1, "dashboard-tabs__tab", 3, "click"], ["aria-hidden", "true", 1, "material-icons"], [1, "card", "revenue-section"], [1, "revenue-section__header"], [1, "revenue-section__heading"], [1, "revenue-section__title"], [1, "revenue-section__platform-badge"], [1, "revenue-section__totals"], [1, "revenue-section__total"], [1, "revenue-section__total-value"], [1, "revenue-section__total-label"], [1, "revenue-section__total-value", "revenue-section__total-value--net"], [1, "revenue-section__controls"], [1, "revenue-section__presets"], ["type", "button", 1, "revenue-section__preset", 3, "revenue-section__preset--active"], [1, "revenue-section__custom-range"], [1, "revenue-section__date-field"], ["type", "date", 3, "change", "value", "max"], ["type", "date", 3, "change", "value", "min"], ["type", "button", "appRipple", "", 1, "btn", "btn--ghost", "revenue-section__refresh", 3, "click", "disabled"], ["role", "alert", 1, "form-alert", "form-alert--error"], [1, "field__hint"], [1, "revenue-section__chart-wrapper"], [1, "card", "cumulative-balance-section"], [1, "card", "operation-section"], [1, "operation-section__header"], [1, "operation-section__title"], [1, "live-indicator"], ["aria-hidden", "true", 1, "live-indicator__dot"], [1, "stat-grid"], [1, "stat-card"], ["aria-hidden", "true", 1, "material-icons", "stat-card__icon"], [1, "stat-card__label"], [1, "stat-card__value"], ["type", "button", 1, "revenue-section__preset", 3, "click"], ["aria-hidden", "true", 1, "revenue-section__chart-loading"], ["primaryLabel", "Faturado", "comparisonLabel", "L\xEDquido recebido", 3, "points", "comparisonPoints", "height"], [1, "revenue-section__spinner"], ["primaryLabel", "Saldo acumulado", 3, "points", "height"], [1, "floor-plan-section__header"], [1, "floor-plan-section__title"], [1, "floor-plan-section__tabs"], [3, "floorPlanId"], ["type", "button", 1, "floor-plan-section__tab", 3, "floor-plan-section__tab--active"], ["type", "button", 1, "floor-plan-section__tab", 3, "click"]], template: function DashboardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(4);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(5, "app-subscription-banner");
      \u0275\u0275template(6, DashboardComponent_Conditional_6_Template, 3, 0, "div", 3)(7, DashboardComponent_Conditional_7_Template, 122, 28)(8, DashboardComponent_Conditional_8_Template, 1, 0, "app-admin-pedidos")(9, DashboardComponent_Conditional_9_Template, 1, 0, "app-admin-servicos")(10, DashboardComponent_Conditional_10_Template, 8, 2, "div", 4);
    }
    if (rf & 2) {
      let tmp_0_0;
      let tmp_1_0;
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.availableTabs().length > 1 ? 6 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.activeTab() === "overview" ? 7 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.activeTab() === "pedidos" ? 8 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.activeTab() === "servicos" ? 9 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.activeTab() === "floorplan" ? 10 : -1);
    }
  }, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardComponent, { className: "DashboardComponent", filePath: "src\\app\\features\\admin\\pages\\dashboard\\dashboard.component.ts", lineNumber: 58 });
})();
export {
  DashboardComponent
};
//# sourceMappingURL=chunk-IC3ARHYL.js.map
