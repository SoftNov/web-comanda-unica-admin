...
var AuthShellComponent = class _AuthShellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthShellComponent, selectors: [["app-auth-shell"]], inputs: { eyebrow: "eyebrow", title: "title", subtitle: "subtitle" }, standalone: true, features: [\u0275\u0275StandaloneFeature], ngContentSelectors: _c0, decls: 32, vars: 4, consts: [[1, "auth"], [1, "auth__branding"], ["aria-hidden", "true", 1, "auth__glow", "auth__glow--accent"], ["aria-hidden", "true", 1, "auth__glow", "auth__glow--success"], ["aria-hidden", "true", 1, "auth__grid"], ["routerLink", "/", "aria-label", "Comanda \xDAnica \u2014 p\xE1gina inicial", 1, "auth__logo"], ["src", "/assets/images/logo-mark.png", "alt", "", "aria-hidden", "true", 1, "auth__logo-mark"], [1, "auth__branding-content"], [1, "auth__highlights"], [1, "auth__branding-footer"], [1, "auth__panel"], [1, "auth__card"], ["routerLink", "/", "aria-label", "Comanda \xDAnica \u2014 p\xE1gina inicial", 1, "auth__mobile-logo"], [1, "eyebrow"], [1, "auth__subtitle"], ["aria-hidden", "true", 1, "material-icons"]], template: function AuthShellComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
//# sourceMappingURL=chunk-IW6PKVMX.js.map
