...
var AuthService = class _AuthService {
  ...
  isPlatformAdmin = computed(() => this.session()?.platformAdmin ?? false);
  ...
  persistSession(session) {
    const maxAgeSeconds = Math.max(1, Math.floor((apiDateTime(session.expiresAt) - Date.now()) / 1e3));
...
//# sourceMappingURL=chunk-2VOFBJJ2.js.map
