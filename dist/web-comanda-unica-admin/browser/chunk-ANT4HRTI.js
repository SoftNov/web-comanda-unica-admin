...
function RegisterComponent_Conditional_2_Conditional_17_Conditional_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (ctx_r1.account.controls.password.errors == null ? null : ctx_r1.account.controls.password.errors["required"]) ? "Informe uma senha." : "A senha n\xE3o atende aos requisitos abaixo.", " ");
  }
}
function RegisterComponent_Conditional_2_Conditional_17_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 16);
...
function RegisterComponent_Conditional_2_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(34);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(35, RegisterComponent_Conditional_2_Conditional_17_Conditional_35_Template, 2, 1, "span", 16);
    \u0275\u0275element(36, "app-password-rules", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 12)(38, "label", 27);
    \u0275\u0275text(39, "Confirmar senha");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "div", 14);
    \u0275\u0275element(41, "input", 28);
    \u0275\u0275elementStart(42, "button", 25);
    \u0275\u0275listener("click", function RegisterComponent_Conditional_2_Conditional_17_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(44);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(45, RegisterComponent_Conditional_2_Conditional_17_Conditional_45_Template, 2, 0, "span", 16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "button", 29);
    \u0275\u0275listener("click", function RegisterComponent_Conditional_2_Conditional_17_Template_button_click_46_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("password", ctx_r1.account.controls.password.value);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((ctx_r1.account.errors == null ? null : ctx_r1.account.errors["passwordMismatch"]) && ctx_r1.account.controls.confirmPassword.touched ? 45 : -1);
  }
}
...
function RegisterComponent_Conditional_2_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 30)(1, "h2", 11);
    \u0275\u0275text(2, "Informa\xE7\xF5es do estabelecimento");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 12)(4, "label", 31);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 12)(10, "label", 33);
    \u0275\u0275text(11, "CNPJ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 14)(13, "input", 34);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 12)(16, "label", 35);
    \u0275\u0275text(17, "Segmento");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 14)(19, "select", 36)(20, "option", 37);
    \u0275\u0275text(21, "Selecione um segmento");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(22, RegisterComponent_Conditional_2_Conditional_18_For_23_Template, 2, 2, "option", 38, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(24, RegisterComponent_Conditional_2_Conditional_18_Conditional_24_Template, 2, 0, "span", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 12)(26, "label", 39);
    \u0275\u0275text(27, "Telefone");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "div", 14)(29, "input", 40);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 12)(32, "label", 41);
    \u0275\u0275text(33, "E-mail");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 14);
    \u0275\u0275element(35, "input", 42);
    \u0275\u0275elementEnd();
...
function RegisterComponent_Conditional_2_Conditional_19_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 68)(1, "span", 2);
...
function RegisterComponent_Conditional_2_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 46)(1, "h2", 11);
    \u0275\u0275text(2, "Localiza\xE7\xE3o do estabelecimento");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 12)(4, "label", 47);
    \u0275\u0275text(5, "CEP");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 14)(7, "input", 48);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, RegisterComponent_Conditional_2_Conditional_19_Conditional_8_Template, 2, 0, "span", 49)(9, RegisterComponent_Conditional_2_Conditional_19_Conditional_9_Template, 2, 0, "span", 16)(10, RegisterComponent_Conditional_2_Conditional_19_Conditional_10_Template, 2, 1, "span", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 12)(12, "label", 50);
    \u0275\u0275text(13, "Rua ");
    \u0275\u0275elementStart(14, "span", 51);
    \u0275\u0275text(15, "(preenchimento autom\xE1tico)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 14);
    \u0275\u0275element(17, "input", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275template(18, RegisterComponent_Conditional_2_Conditional_19_Conditional_18_Template, 2, 0, "span", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 12)(20, "label", 53);
    \u0275\u0275text(21, "N\xFAmero");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div", 14);
    \u0275\u0275element(23, "input", 54);
    \u0275\u0275elementEnd();
    \u0275\u0275template(24, RegisterComponent_Conditional_2_Conditional_19_Conditional_24_Template, 2, 0, "span", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 12)(26, "label", 55);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(67, RegisterComponent_Conditional_2_Conditional_19_Conditional_67_Template, 4, 1, "div", 68);
    \u0275\u0275elementStart(68, "div", 43)(69, "button", 44);
...
function RegisterComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(17, RegisterComponent_Conditional_2_Conditional_17_Template, 48, 25)(18, RegisterComponent_Conditional_2_Conditional_18_Template, 42, 15)(19, RegisterComponent_Conditional_2_Conditional_19_Template, 74, 22);
    \u0275\u0275elementEnd();
